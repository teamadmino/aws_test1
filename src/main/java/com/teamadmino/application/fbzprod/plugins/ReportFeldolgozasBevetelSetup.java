...
public class ReportFeldolgozasBevetelSetup {
    ...
    public static void run_action(RequestContext rc) throws Exception {
        ...
        settings.put("feldolgozasGeneric_group", rc.getValueString("reportType"));
        settings.put("feldolgozasGeneric_filters", filters);
        sessionVars.put(sid, settings);

        int jobId = createJob(new JobConfig("Feldolgozás Bevétel")
